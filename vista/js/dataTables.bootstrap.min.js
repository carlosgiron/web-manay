...
(function(b) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(a) {
    ...
    b.extend(!0, f.defaults, { dom: "<'row'<'col-xs-60 col-sm-30 col-md-30 col-lg-30'f><'col-xs-60 col-sm-30 col-md-30 col-lg-30'l>><'row'<'col-xs-60 col-sm-60 col-md-60 col-lg-60 table-responsive'tr>><'row'<'col-xs-60 col-sm-20 col-md-20 col-lg-20'i><' col-xs-60 col-sm-40 col-md-40 col-lg-40'p>>", renderer: "bootstrap" });


    b.extend(f.ext.classes, { sWrapper: "dataTables_wrapper form-inline dt-bootstrap", sFilterInput: "form-control", sLengthSelect: "form-control", sProcessing: "dataTables_processing panel panel-default" });
