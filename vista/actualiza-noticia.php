...
$upNoticia = new NoticiaControlador();
//$regImagenControlador= new ImagenRegistroControlador();

if (isset($_POST["idNoticia"]) || isset($_POST["nombre_noticia"]) || isset($_POST["descripcion_noticia"])) {
...
//    $fecha_publicacion =  DateTime();
    ...
    if ($upNoticia->ActualizaNoticia($_POST["nombre_noticia"], $_POST["descripcion_noticia"], $add, $fecha_noticia, $_POST["idNoticia"])) {
        header("location:registro-noticia.php");
    } else {

        echo "<script>alert('Error al Actualizar Servicio');</script>";
    }
}
